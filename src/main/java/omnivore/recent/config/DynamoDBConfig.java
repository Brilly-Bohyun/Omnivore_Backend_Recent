package omnivore.recent.config;
...
@Configuration
@EnableDynamoDBRepositories(basePackageClasses = {UserHistoryRepository.class, RestaurantRepository.class, UserRepository.class})
